      ...
      return {
        a: common_vendor.f(singleList.value, (p, index, i0) => {
          return {
            ...
            d: common_vendor.t(p.singerName),
            e: index,
            f: "43fdda39-1-" + i0 + ",43fdda39-0"
          };
        })
      };
    };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "Z:/U盘资源拷贝/namelessMusic/音乐/pages/trends/trends.vue"]]);
